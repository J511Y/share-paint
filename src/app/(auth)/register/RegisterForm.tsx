...
export function RegisterForm() {
  ...
  const onSocialSignup = async (provider: SocialAuthProvider) => {
    setError(null);
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center">
        ...
        <CardDescription>Google, Kakao, Naver 계정으로 바로 시작할 수 있습니다.</CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="rounded-lg bg-gray-100 p-3 text-sm text-gray-700">
          이메일/비밀번호 회원가입은 지원하지 않습니다. 소셜 계정으로만 가입할 수 있습니다.
        </div>
            ...
            return (
              <div key={provider} className="space-y-1">
                <Button
                  ...
                  onClick={() => onSocialSignup(provider)}
                >
                  {SOCIAL_AUTH_PROVIDER_LABELS[provider]}로 시작하기
                </Button>
