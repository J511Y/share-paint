...
| 컴포넌트 | 상태 | 설명 |
|----------|------|------|
| Canvas.tsx | ⏳ 대기 | 메인 캔버스 렌더링 |
| CanvasToolbar.tsx | ⏳ 대기 | 펜/지우개/채우기 도구 선택 |
| ColorPicker.tsx | ⏳ 대기 | 색상 선택 UI |
| BrushSizeSlider.tsx | ⏳ 대기 | 브러시 크기 조절 |
| CanvasActions.tsx | ⏳ 대기 | Undo/Redo/Clear/Export |
| index.ts | ⏳ 대기 | 배럴 export |
